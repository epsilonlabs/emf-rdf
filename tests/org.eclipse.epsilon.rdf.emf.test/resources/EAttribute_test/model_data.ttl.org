...
<firstEntity>
    ...
    simple:names ( "firstName" "secondName" ) ;
...
#    simple:eCharacterObjects ( "A"^^xsd:string "B"^^xsd:string ) ;
    ...
    simple:eDouble "1"^^xsd:double ;
    simple:eDoubles ( "1"^^xsd:double "2"^^xsd:double );
    
    simple:eDoubleObject "2"^^xsd:double ;
    simple:eDoubleObjects ( "1"^^xsd:double "2"^^xsd:double );
    ...
    simple:eDate "2001-12-30T00:00:00"^^xsd:dateTime ;
    simple:eDates ( "2001-12-30T00:00:00"^^xsd:dateTime "2001-12-29T01:00:00"^^xsd:dateTime ) .
